...
//-------------------------------------------------
        case (CLKSWING_CFG)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute CLKSWING_CFG on IBUFDS_GTE2 instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE", CLKSWING_CFG);
                          $finish;
                      end
