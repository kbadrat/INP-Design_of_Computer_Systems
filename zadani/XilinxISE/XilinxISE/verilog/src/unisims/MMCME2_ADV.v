// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/fuji/MMCME2_ADV.v,v 1.10 2010/10/28 20:12:09 yanx Exp $
///////////////////////////////////////////////////////////////////////////////
             ...
             if (daddr_in == 7'b0010100) begin
               ...
               if (SIM_DEVICE == "VIRTEX6") begin
                 if (clkfbtmp_divi > 64 || (clkfbtmp_divi < 5))
                  $display(" Input Error : DI at Address DADDR=%b is %h at MMCME2_ADV instance %m at time %t. The sum of DI[11:6] and DI[5:0] is %b and over the range of %d to %d.",  daddr_in, di_in, clkfbtmp_divi, $time, 5, 64);
               end
               else begin
                 if (clkfbtmp_divi > M_MAX || (clkfbtmp_divi < M_MIN))
                  $display(" Input Error : DI at Address DADDR=%b is %h at MMCME2_ADV instance %m at time %t. The sum of DI[11:6] and DI[5:0] is %d and over the range of %f to %f.",  daddr_in, di_in, clkfbtmp_divi, $time, M_MIN, M_MAX);
               end
            end
