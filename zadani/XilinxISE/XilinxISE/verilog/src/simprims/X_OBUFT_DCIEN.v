...
module X_OBUFT_DCIEN (O, DCITERMDISABLE, I, T);
    ...
    initial begin
        ...
        case (CAPACITANCE)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute CAPACITANCE on X_OBUFT_DCIEN instance %m is set to %s.  Legal values for this attribute are DONT_CARE, LOW or NORMAL.", CAPACITANCE);
                          $finish;
                      end
