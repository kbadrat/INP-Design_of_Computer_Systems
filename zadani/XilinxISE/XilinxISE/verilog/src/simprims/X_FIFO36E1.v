// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/blanc/X_FIFO36E1.v,v 1.20.8.1 2011/01/13 00:31:51 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
// xilinx_internal_parameter off
    ...
    // DRC
    always @(posedge rden_in)
	@(posedge rdclk_in)
	if (first_rst_flag == 0) begin
