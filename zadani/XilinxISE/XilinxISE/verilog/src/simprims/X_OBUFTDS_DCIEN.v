...
// /___/   /\     Filename : X_OBUFTDS_DCIENS.v
...
module X_OBUFTDS_DCIEN (O, OB, DCITERMDISABLE, I, T);
    ...
    initial begin
        ...
        case (CAPACITANCE)
            ...
            default : begin
                          $display("Attribute Syntax Error : The attribute CAPACITANCE on X_OBUFTDS_DCIENS instance %m is set to %s.  Legal values for this attribute are DONT_CARE, LOW or NORMAL.", CAPACITANCE);
                          $finish;
                      end
