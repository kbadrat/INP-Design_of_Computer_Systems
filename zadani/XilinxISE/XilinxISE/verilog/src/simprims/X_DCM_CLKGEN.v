// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/stan/X_DCM_CLKGEN.v,v 1.15 2010/07/01 20:58:54 yanx Exp $
///////////////////////////////////////////////////////////////////////////////
...
//
  ...
  always @(posedge lk_pd0 or posedge rst_lk or posedge dcm_en_lk 
   ...
   assign locked_out_ms1 =  (spa == 0 || (spa >= 3 && spa <= 5 && spse == 0)) ? locked_out_g : 0;
