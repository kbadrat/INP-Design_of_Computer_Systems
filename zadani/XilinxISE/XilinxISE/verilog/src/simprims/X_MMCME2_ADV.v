// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/versclibs/data/fuji/X_MMCME2_ADV.v,v 1.10 2010/10/28 20:12:31 yanx Exp $
///////////////////////////////////////////////////////////////////////////////
...
//  `endif
  ...
  reg [5:0] clkout5f_dly, clkout6f_dly;
...
*/
  ...
  case (clkfb_div_fint)
    ...
    if (clkfb_frac_en == 1) begin
      ...
      clkout6f_dly = clkfb_div_fint /2;
      if (clkfb_div_fint_odd > 0) begin
        clk6fpm_sel = (8 + clkfb_div_frac_int) / 2;
        ...
        clkfbm1pm_sel_int = 8 + clkfb_div_frac_int - (8 + clkfb_div_frac_int) / 2 ;
         ...
         clk6fpm_sel = clkfb_div_frac_int / 2;
      end
    end
    else begin
      tmp_string = "CLKFBOUT_PHASE";
    ...
    if (clk0_frac_en == 1) begin
      ...
      clkout5f_dly = clk0_div_fint /2;
      if (clk0_div_fint_odd > 0) begin
        clk5fpm_sel = (8 + clk0_div_frac_int) / 2;     
        ...
        clk0pm_sel_int = 8 + clk0_div_frac_int - (8 + clk0_div_frac_int) / 2;
         ...
         clk5fpm_sel = clk0_div_frac_int / 2;
      end
    end
    else begin
      tmp_string = "CLKOUT0_PHASE";
  ...
  if ($time > 1 && rst_in === 0 && (clkinsel_tmp === 0 || clkinsel_tmp === 1)) begin
    ...
    clkin_chk_t1 = 1000.000 / CLKIN_FREQ_MIN;
    clkin_chk_t2 = 1000.000 / CLKIN_FREQ_MAX;
             ...
             if (daddr_in == 7'b0010100) begin
               ...
               if (SIM_DEVICE == "VIRTEX6") begin
                 if (clkfbtmp_divi > 64 || (clkfbtmp_divi < 5))
                  $display(" Input Error : DI at Address DADDR=%b is %h at X_MMCME2_ADV instance %m at time %t. The sum of DI[11:6] and DI[5:0] is %b and over the range of %d to %d.",  daddr_in, di_in, clkfbtmp_divi, $time, 5, 64);
               end
               else begin
                 if (clkfbtmp_divi > M_MAX || (clkfbtmp_divi < M_MIN))
                  $display(" Input Error : DI at Address DADDR=%b is %h at X_MMCME2_ADV instance %m at time %t. The sum of DI[11:6] and DI[5:0] is %d and over the range of %f to %f.",  daddr_in, di_in, clkfbtmp_divi, $time, M_MIN, M_MAX);
               end
            end
...
//  assign  clkinstopped_hold = (clkin_hold_f == 1) ? clkinstopped_out : 0;
  ...
  if (period_avg > 0 ) begin
    ...
    clk0_frac_lt = period_vco * clkout5f_dly + (period_vco * clk5fpm_sel) / 8;
    clkfb_frac_ht = period_vco * clkfbm1_dly + (period_vco * clkfbm1pm_sel_int) / 8;
    clkfb_frac_lt = period_vco * clkout6f_dly + (period_vco * clk6fpm_sel) / 8;
  end
