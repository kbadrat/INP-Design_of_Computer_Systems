   ...
   initial begin
      case (PART_NAME)
         ...
         default : begin
                        ...
                        $display("Attribute Syntax Error : The attribute PART_NAME on X_JTAG_SIME2 instance %m is set to %s. The legal values for this attributes are 7A20, 7A40, 7A105,  7A175T, 7A335T, 7K30T, 7K70T, 7K120T, 7K230T, 7V285T, 7V450T, 7V585T, 7V855T, 7VX415T, 7V1500T or 7V2000T.",  PART_NAME);
         end
